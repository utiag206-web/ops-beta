...
export default function CompanyProfilePage() {
 ...
 <span className="text-blue-700 font-bold text-sm tracking-wide">Configuración Activa</span>
 </div>
 </div>
 ...
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Razón Social *</label>
 <input
 required
 type="text"
 value={formData.name}
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">ID Fiscal / RUC</label>
 <input
 type="text"
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Dirección Matriz *</label>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">E-mail Corporativo *</label>
 <input
 required
 type="email"
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Teléfono Central *</label>
 <input
 required
 type="tel"
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Sector / Industria</label>
 <select
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Zona Horaria</label>
 <select
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Horario Laboral Sugerido</label>
 <input
 type="text"
 ...
 <label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1">Logo Institucional</label>
