...
export default function MovementsClient({ initialMovements, workers, userRole }: MovementsPageProps) {
 ...
 <p className="text-slate-500 font-bold mt-1 tracking-tight text-[10px] opacity-70">Control de Subidas y Bajadas de Mina</p>
 </div>
 {isManager && (
 <button 
 onClick={() => setShowModal(true)}
 className="bg-slate-900 hover:bg-black text-white px-8 py-4 rounded-2xl font-black text-xs tracking-tight flex items-center gap-2 transition-all shadow-xl hover:scale-105 active:scale-95"
 >
 ...
 <th className="px-10 py-5 text-[10px] font-black text-slate-400 tracking-tight">Trabajador</th>
 <th className="px-10 py-5 text-[10px] font-black text-slate-400 tracking-tight">Ubicación</th>
 <th className="px-10 py-5 text-[10px] font-black text-slate-400 tracking-tight">Movimiento</th>
 <th className="px-10 py-5 text-[10px] font-black text-slate-400 tracking-tight">Fecha Operativa</th>
 <th className="px-10 py-5 text-[10px] font-black text-slate-400 tracking-tight text-center">Estado</th>
 <th className="px-10 py-5 text-[10px] font-black text-slate-400 tracking-tight text-right">Acciones</th>
 </tr>
 </thead>
 ...
 <span className="text-[10px] text-slate-400 font-bold tracking-tight">Personal</span>
 </div>
 </div>
 </td>
 <td className="px-10 py-5">
 ...
 <span className={`inline-flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-[10px] font-black tracking-widest ${
 item.status === 'En mina' 
 ...
 <p className="text-slate-400 font-black text-sm tracking-tight">Sin registros operativos</p>
 </div>
 </td>
 </tr>
 )}
 ...
 <label className="text-[10px] font-black text-slate-400 tracking-tight ml-1 flex items-center gap-2">
 ...
 type="button"
 onClick={closeModal}
 className="flex-1 bg-slate-100 text-slate-600 py-5 rounded-[1.5rem] font-black text-sm hover:bg-slate-200 transition-all tracking-tight"
 >
 Cancelar
 </button>
 <button 
 type="submit"
 disabled={saving}
 className="flex-[2] bg-blue-600 text-white py-5 rounded-[1.5rem] font-black text-sm hover:bg-blue-700 transition-all shadow-xl shadow-blue-200 flex items-center justify-center gap-3 disabled:opacity-50 tracking-tight"
 >
