...
export function KardexClient({ products, warehouses }: { products: any[], warehouses: any[] }) {
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1 mb-1 block">Código</label>
 <input 
 type="text"
 placeholder="CÓDIGO..."
 value={codeValue}
 onChange={(e) => handleCodeChange(e.target.value)}
 className="w-full h-[54px] bg-slate-50 border-2 border-transparent focus:border-indigo-500 rounded-2xl px-4 text-sm font-black transition-all outline-none"
 />
 </div>

 <div className="md:col-span-4">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1 mb-1 block">Descripción del Producto *</label>
 <select 
 value={productId}
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1 mb-1 block">Almacén</label>
 <select 
 value={warehouseId}
 ...
 <div>
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1 mb-1 block">Desde</label>
 <input 
 type="date"
 value={dateFrom}
 ...
 <div>
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1 mb-1 block">Hasta</label>
 <input 
 type="date"
 value={dateTo}
 ...
 <div>
 <p className="text-[11px] font-black text-indigo-600 tracking-[0.2em] mb-1">Libro de Inventario Continuo</p>
 <h2 className="text-2xl font-black text-slate-800 tracking-tight flex items-center gap-3">
 {selectedProduct?.name}
 <span className="text-slate-300 font-medium">/</span>
 <span className="text-slate-400 text-lg font-bold">{selectedProduct?.code}</span>
 </h2>
 </div>
 </div>
 ...
 <p className="text-[10px] font-black text-slate-400 tracking-tight mb-1">Saldo Inicial Periodo</p>
 ...
 <span className="text-[11px] font-bold text-slate-400">{selectedProduct?.unit}</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight w-40">Fecha</th>
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight w-40">Tipo</th>
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight w-48">Documento</th>
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight">Almacén / Contexto</th>
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight text-center bg-slate-50/30">Entrada</th>
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight text-center bg-slate-50/30">Salida</th>
 <th className="py-5 px-6 text-[10px] font-black text-indigo-600 tracking-tight text-center bg-indigo-50/20">Saldo</th>
 <th className="py-5 px-6 text-[10px] font-black text-slate-500 tracking-tight">Responsable / Obs.</th>
 </tr>
 </thead>
 ...
 <div className="flex items-center gap-1 text-[9px] text-slate-400 font-bold tracking-tighter">
 <Clock size={10} />
 ...
 <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border text-[10px] font-black tracking-tight ${
 ...
 <span className="text-[9px] font-bold text-slate-400 ml-4.5">
 {m.warehouses?.name}
 </span>
 </>
 ) : (
 ...
 <span className="text-[9px] font-black text-slate-500 truncate max-w-[100px]" title={m.users?.name}>
 ...
 <p className="text-[11px] font-black text-slate-400 tracking-tight">
