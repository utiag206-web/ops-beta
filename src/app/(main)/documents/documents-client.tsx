...
export default function DocumentsClient({ initialDocuments, workers, userRole }: DocumentsPageProps) {
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-400 tracking-tight ml-1">Nombre del Documento</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-400 tracking-tight ml-1">Tipo</label>
 <select required className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl p-3 font-bold outline-none focus:border-blue-600 text-slate-800"
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-400 tracking-tight ml-1">Vencimiento (Opcional)</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-400 tracking-tight ml-1">Archivo (Opcional)</label>
 ...
 <th className="px-8 py-5 text-[10px] font-black text-slate-400 tracking-tight">Trabajador</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-400 tracking-tight">Documento</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-400 tracking-tight">Tipo</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-400 tracking-tight">Vencimiento</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-400 tracking-tight">Estado</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-400 tracking-tight text-right">Acciones</th>
 </tr>
 </thead>
 ...
 <td className="px-8 py-5">
 <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black tracking-wider border ${status.color}`}>
 <Icon size={12} />
 {status.label}
 </div>
 </td>
