...
export default function WarehousesPage() {
 ...
 <p className="text-slate-500 text-sm font-bold tracking-tight">Configuración Maestra / ERP</p>
 </div>
 </div>
 </div>
 ...
 <span className="tracking-tight text-xs">Nuevo Almacén</span>
 </button>
 )}
 </div>
 ...
 <p className="text-slate-500 font-black tracking-tight text-xs">Sincronizando ubicaciones...</p>
 </div>
 ...
 <span className="text-[10px] font-black tracking-tighter text-slate-400 bg-slate-50 px-3 py-1.5 rounded-full">
 ID: {w.id.slice(0, 8)}...
 </span>
 <div className="flex gap-2">
 {w.is_default && (
 <span className="text-[10px] font-black text-amber-600 bg-amber-50 px-3 py-1.5 rounded-full border border-amber-100">
 Principal
 </span>
 )}
 <span className="text-[10px] font-black text-indigo-500 bg-indigo-50 px-3 py-1.5 rounded-full">
 Activo
 </span>
 </div>
 </div>
