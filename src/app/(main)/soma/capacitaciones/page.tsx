                    ...
                    <td className="px-10 py-8 text-right flex justify-end gap-2 items-center whitespace-nowrap">
                      {t.material_url && (
                        <a 
                          ...
                          className="px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 rounded-xl text-indigo-600 transition-all text-xs font-bold uppercase tracking-widest flex items-center gap-1 shadow-sm border border-indigo-100"
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 md:p-8 custom-scrollbar">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-2">Material de Apoyo / Enlace</label>
                <input 
                  type="url" 
        ...
        <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest mt-0.5">Seguridad y Salud Ocupacional (SOMA)</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar text-left">
          ...
          <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-4">
            <div className="flex justify-between items-start gap-4">
              ...
              <span className={`px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm shrink-0 ${statusColor}`}>
                {expiryStatus}
              </span>
            </div>
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Descripción</h4>
          ...
          {training.material_url && (
            <div className="space-y-2">
              <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Material de Apoyo</h4>
              <a 
        ...
        <div className="p-8 border-b border-slate-50 flex justify-between items-center bg-amber-50/30">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 font-bold text-sm tracking-tight text-amber-500 uppercase">Modificar Registro SOMA</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2 hover:bg-slate-100 rounded-full transition-colors text-slate-400">
            <X size={24} />
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <input 
                  ...
                  onChange={e => setFormData(prev => ({...prev, title: e.target.value.toUpperCase()}))}
                  placeholder="EJ: INDUCCIÓN GENERAL DE SEGURIDAD"
                  className="w-full px-6 md:px-8 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 font-bold text-slate-700 uppercase"
                />
              </div>
            ...
            <div className="flex flex-col bg-slate-50/50 rounded-[2rem] p-6 md:p-8 border border-slate-100/50 h-[380px] max-h-[380px]">
              <div className="flex items-center justify-between mb-6">
                ...
                <button 
                  type="button" 
                  onClick={selectAll}
                  className="text-[10px] font-bold text-amber-600 hover:text-amber-700 uppercase tracking-widest bg-amber-50 px-3 py-1.5 rounded-lg transition-all"
                >
                  {formData.participants.length === workers.length ? 'Deseleccionar todos' : 'Seleccionar todos'}
                </button>
              </div>
