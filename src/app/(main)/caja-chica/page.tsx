    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
          ...
          <div>
            {['admin', 'gerente', 'super_admin', 'superadmin'].includes(role_id || '') ? (
              <div className="flex flex-col gap-1">
                <p className="text-[10px] font-bold text-blue-600 uppercase tracking-widest ml-1">Vista Administrativa Central</p>
                <select 
                  value={area}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-slate-900 p-8 rounded-[2rem] shadow-2xl relative overflow-hidden col-span-1 md:col-span-1">
           ...
           <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-2">Saldo en Caja</p>
           ...
           <div className="flex items-center gap-2">
             <span className="px-3 py-1 bg-white/10 rounded-full text-[10px] font-bold text-white uppercase tracking-tighter">Fondo Activo</span>
           </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm col-span-1">
           ...
           <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Gastos (Mes)</p>
           <h3 className="text-2xl font-bold text-slate-900 tracking-tighter">
        ...
        <div className="bg-blue-50 p-6 rounded-[2rem] border border-blue-100 flex flex-col justify-center gap-4 col-span-1">
           <div className="flex justify-between items-center text-[11px] font-bold text-blue-900/60 uppercase">
             <span>Período</span>
          ...
          <div className="flex items-center gap-3 bg-slate-50 p-1.5 rounded-[1.5rem] border border-slate-100 w-full lg:w-auto overflow-x-auto no-scrollbar">
             {[
               ...
               <button 
                ...
                className={`px-6 py-3 text-[10px] font-bold uppercase tracking-widest rounded-xl transition-all whitespace-nowrap ${
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-slate-50/50">
                <th className="py-5 px-8 text-[11px] font-bold text-slate-400 uppercase tracking-widest">Fecha</th>
                ...
                <tr key={t.id} className="hover:bg-slate-50/50 transition-all group animate-in slide-in-from-left duration-300">
                  ...
                  <td className="py-7">
                    <div className="flex flex-col gap-1.5">
                      <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold text-slate-400 uppercase">{t.responsible?.name}</span>
                  ...
                  <td className="py-7 max-w-sm">
                    ...
                    <div className="flex items-center gap-3">
                       <div className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 rounded-lg">
                          ...
                          <span className="text-[9px] font-bold text-slate-500 uppercase tracking-tighter">{t.payment_method}</span>
                       </div>
                    </div>
                  </td>
                  ...
                  <td className="py-7 text-right px-8">
                    <div className="flex flex-col items-end gap-1">
                      ...
                      <span className={`text-[9px] font-bold uppercase tracking-widest ${t.type === 'ingreso' ? 'text-emerald-400' : 'text-slate-400'}`}>
