...
export default async function WorkerPortalPage({ params }: PageProps) {
 ...
 <h1 className="text-xl font-black text-white tracking-tight">Acceso Denegado</h1>
 <p className="text-xs font-bold text-rose-400 tracking-tight">Empresa No Registrada</p>
 </div>
 ...
 <script dangerouslySetInnerHTML={{
   __html: `document.cookie = 'worker_session=; Max-Age=0; path=/;';`
 }} />
 </div>
 </div>
 )
