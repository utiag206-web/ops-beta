...
export function AddBonusModal({ workers, onSuccess, onClose }: AddBonusModalProps) {
 ...
 className={`flex-1 py-2 px-3 rounded-lg text-xs font-black tracking-wider transition-all ${type === 'bono' ? 'bg-white text-amber-600 shadow-sm border border-amber-100' : 'text-slate-400 hover:text-slate-600'}`}
 >
 Bono
 </button>
 <button 
 ...
 <div>
 <label className="block text-[10px] font-black text-slate-400 tracking-tight mb-1.5 ml-1">Estado Inicial</label>
 ...
 type="button"
 onClick={onClose}
 className="flex-1 px-4 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-2xl font-bold transition-all text-xs tracking-normal"
 >
 Cancelar
 </button>
 <button
 ...
 className={`flex-1 flex items-center justify-center gap-2 text-white px-4 py-3 rounded-2xl font-bold transition-all shadow-md active:scale-95 text-xs tracking-wider ${
