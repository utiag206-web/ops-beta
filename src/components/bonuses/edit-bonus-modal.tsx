...
export function EditBonusModal({ bonus, workers, onSuccess, onClose }: EditBonusModalProps) {
 ...
 <div>
 <h3 className="text-xl font-bold tracking-tight">Editar Registro</h3>
 ...
 <div>
 <label className="block text-[10px] font-black text-slate-400 tracking-tight mb-2 ml-1">Tipo de Registro</label>
 <div className="flex gap-2 bg-slate-50 p-1 rounded-xl border border-slate-100">
 <button 
 type="button" 
 onClick={() => setType('bono')}
 className={`flex-1 py-2 px-3 rounded-lg text-xs font-black tracking-wider transition-all ${type === 'bono' ? 'bg-white text-orange-600 shadow-sm border border-orange-100' : 'text-slate-400 hover:text-slate-600'}`}
 >
 Bono
 </button>
 <button 
 ...
 className={`flex-1 py-2 px-3 rounded-lg text-xs font-black tracking-wider transition-all ${type === 'pasaje' ? 'bg-white text-blue-600 shadow-sm border border-blue-100' : 'text-slate-400 hover:text-slate-600'}`}
 >
 Pasaje
 </button>
 <button 
 ...
 className={`flex-1 py-2 px-3 rounded-lg text-xs font-black tracking-wider transition-all ${type === 'pago' ? 'bg-white text-emerald-600 shadow-sm border border-emerald-100' : 'text-slate-400 hover:text-slate-600'}`}
 >
 Pago
 </button>
 </div>
 ...
 <div>
 <label className="block text-[10px] font-black text-slate-400 tracking-tight mb-1.5 ml-1">Colaborador</label>
 ...
 <>
 <div>
 <label className="block text-[10px] font-black text-slate-400 tracking-tight mb-1.5 ml-1">
 Tipo de Pago
 </label>
 <select
 value={paymentType}
 ...
 <label className="block text-[10px] font-black text-slate-400 tracking-tight ml-1">
 ...
 <div className="space-y-1">
 <label className="block text-[10px] font-black text-slate-400 tracking-tight ml-1">Monto (S/)</label>
 <div className="relative">
 ...
 <div className="space-y-1">
 <label className="block text-[10px] font-black text-slate-400 tracking-tight ml-1">Fecha</label>
 <div className="relative">
 ...
 <div className="space-y-1">
 <label className="block text-[10px] font-black text-slate-400 tracking-tight ml-1">Estado del Pago</label>
 <select 
 name="status"
 ...
 type="button" 
 onClick={onClose}
 className="flex-1 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-2xl transition-all text-xs tracking-normal cursor-pointer"
 >
 Cancelar
 </button>
 <button 
 ...
 className={`flex-1 py-3 text-white font-bold rounded-2xl transition-all shadow-lg text-xs tracking-wider flex items-center justify-center gap-2 cursor-pointer active:scale-95 ${
