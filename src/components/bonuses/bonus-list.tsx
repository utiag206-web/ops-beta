                  ...
                  <tr key={bonus.id} className="hover:bg-slate-50/30 transition-colors group">
                    ...
                    <td className="py-5 px-6">
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-slate-700 uppercase tracking-tight">{bonus.bonus_type}</span>
                        <span className={`text-[9px] font-black w-fit mt-1 px-2 py-0.5 rounded uppercase tracking-wider ${
                    ...
                    <td className="py-5 px-6 text-center">
                      <button
                        ...
                        className={`text-[10px] font-bold px-3 py-1 rounded-lg uppercase border shadow-sm transition-all ${
              ...
              <div key={bonus.id} className="p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-1">
                        <p className="text-sm font-bold text-slate-800 uppercase leading-snug">{bonus.bonus_type}</p>
                        <span className={`text-[8px] font-black w-fit px-1.5 py-0.5 rounded uppercase tracking-wider ${
                          isBono ? 'bg-orange-50 text-orange-600 border border-orange-100' : 
                          isPago ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 
                          'bg-blue-50 text-blue-600 border border-blue-100'
                        }`}>
                ...
                <div className="flex items-center justify-between gap-4 pt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-slate-500 uppercase truncate max-w-[120px]">{bonus.worker?.name || 'Sistema'}</span>
                  </div>
                    ...
                    {isAdmin && (
                      <>
                        ...
                        <button
                          ...
                          onClick={() => handleToggleStatus(bonus.id, bonus.status)}
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[9px] font-bold uppercase transition-all shadow-sm cursor-pointer ${
                            bonus.status === 'paid' 
