      ...
      <div className="bg-white w-full max-w-md rounded-[2rem] shadow-2xl overflow-hidden border border-slate-100 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className={`p-6 bg-gradient-to-r text-white flex justify-between items-center ${
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-black tracking-tight uppercase">Detalle del Registro</h3>
        ...
        <div className="p-8 space-y-6">
          <div className="space-y-4 max-h-[60vh] overflow-y-auto custom-scrollbar">
            ...
            {!isPago ? (
              ...
              <>
                ...
                <div className="flex items-start gap-3.5 pb-4 border-b border-slate-50">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Tipo de Pago</p>
                ...
                {['salary', 'advance'].includes(bonus.payment_type) && (
                  <div className="flex items-start gap-3.5 pb-4 border-b border-slate-50">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Periodo</p>
                      <p className="text-sm font-bold text-slate-700 uppercase">
                ...
                {bonus.observations && (
                  <div className="flex items-start gap-3.5 pb-4 border-b border-slate-50">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Observaciones</p>
                ...
                {bonus.document_url && (
                  <div className="flex items-start gap-3.5 pb-4 border-b border-slate-50">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Documento Adjunto</p>
                      <a 
            ...
            <div className="flex items-start gap-3.5 pb-4 border-b border-slate-50">
              ...
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Monto Asignado</p>
            ...
            <div className="flex items-start gap-3.5 pt-2">
              ...
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1.5">Estado del Pago</p>
                <span className={`inline-flex items-center gap-1.5 text-[10px] font-black px-3 py-1 rounded-full uppercase border shadow-sm ${
                  bonus.status === 'paid' 
          ...
          <div className="pt-2">
            <button 
              type="button"
              onClick={onClose} 
              className="w-full py-3 bg-slate-900 hover:bg-black text-white font-bold rounded-2xl transition-all shadow-lg text-xs tracking-wider uppercase active:scale-98 cursor-pointer"
            >
              Cerrar Vista
            </button>
          </div>
