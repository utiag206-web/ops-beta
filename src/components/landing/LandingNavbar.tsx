    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="group flex items-center gap-2.5">
          <div className="relative flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl bg-blue-600 shadow-md shadow-blue-500/20 transition-transform duration-300 group-hover:scale-105 border border-blue-400/30">
            <Image
              src="/logo-ops.png"
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] font-bold tracking-wider text-blue-200 uppercase">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          <a
            href="#que-es"
            className="text-xs lg:text-sm font-semibold text-slate-200 transition-colors hover:text-white"
          >
            Plataforma
          </a>
          <a
        ...
        <div className="hidden items-center gap-2.5 sm:flex">
          <Link
            href="/login"
            className="rounded-xl px-3.5 py-2 text-xs lg:text-sm font-bold text-slate-200 transition-all hover:bg-white/10 hover:text-white"
          >
            Acceder
          </Link>
          <button
            onClick={onOpenDemo}
            className="group inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-xs lg:text-sm font-bold text-white shadow-md shadow-blue-600/30 transition-all duration-200 hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-600/40 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer border border-blue-400/30"
          >
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/20 text-white transition-colors hover:bg-white/10 md:hidden cursor-pointer"
