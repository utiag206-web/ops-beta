...
export function AccountForm({ user }: AccountFormProps) {
 ...
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] ml-1">Nombre Completo</label>
 ...
 <div className="space-y-3">
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] ml-1">Correo Electrónico Corporativo</label>
 <div className="relative group/input">
 ...
 <div className="space-y-3">
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] ml-1">Área / Departamento (Solo Lectura)</label>
 <div className="relative group/input">
 ...
 <div className="space-y-3">
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] ml-1">Nueva Contraseña</label>
 <div className="relative group/input">
 ...
 <div className="space-y-3">
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] ml-1">Re-escribir Contraseña</label>
 <div className="relative group/input">
 <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-emerald-500 transition-colors" size={20} />
 <input 
 type="password" 
