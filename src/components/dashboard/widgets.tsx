...
export function ListWidget({ title, items, icon: Icon, color, hrefLabel, href }: any) {
  return (
    <div className="bg-white p-6 md:p-8 rounded-2xl md:rounded-[3rem] shadow-sm border border-slate-100 flex flex-col h-full hover:shadow-xl transition-all duration-300 group">
...
export function WelcomeHero({ userName, roleName, area, companyName, viewMode }: any) {
  ...
  return (
    <div className="bg-[#1D4ED8] rounded-2xl md:rounded-[3rem] p-6 md:p-10 text-white shadow-2xl relative overflow-hidden group">
      {/* Background effects */}
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
        <div className="max-w-2xl">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-3 tracking-tighter leading-none text-white">
            {content.title} 👋
            <br />
            <span className="text-xl md:text-2xl lg:text-3xl text-blue-100 mt-2 block font-black">Hola, {userName}</span>
          </h1>
