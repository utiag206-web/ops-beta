...
export function AssetForm({ isOpen, onClose, onSuccess, editingAsset }: AssetFormProps) {
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Código / Serie</label>
 <input 
 required
 type="text"
 placeholder="ACT-001"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Nombre del Activo</label>
 <input 
 required
 type="text"
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Estado Operativo</label>
 <select 
 required
 className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-2xl p-4 text-sm font-bold transition-all outline-none"
 value={form.status}
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Ubicación Actual</label>
 <input 
 required
 type="text"
