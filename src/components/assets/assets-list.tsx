          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                ...
                <th className="py-5 px-6 text-[11px] font-bold text-slate-400 uppercase tracking-widest">Activo / Equipo</th>
                <th className="py-5 px-6 text-[11px] font-bold text-slate-400 uppercase tracking-widest">Tipo / Categoría</th>
                <th className="py-5 px-6 text-[11px] font-bold text-slate-400 uppercase tracking-widest">Estado</th>
                <th className="py-5 px-6 text-[11px] font-bold text-slate-400 uppercase tracking-widest text-center">Ubicación</th>
                ...
                <tr key={asset.id} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="py-5 px-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-bold text-blue-600 tracking-widest uppercase">{asset.code}</span>
                    </div>
                  </td>
                  <td className="py-5 px-6">
                  ...
                  <td className="py-5 px-6">
                    <span className={`text-[10px] font-bold px-3 py-1 rounded-lg uppercase border shadow-sm ${getStatusStyle(asset.status)}`}>
                      {asset.status}
                    </span>
                  </td>
