...
export function AssetsList({ initialAssets }: { initialAssets: Asset[] }) {
 ...
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight">Activo / Equipo</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight">Tipo / Categoría</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight">Estado</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight text-center">Ubicación</th>
 ...
 <span className="text-[11px] font-bold text-blue-600 tracking-tight">{asset.code}</span>
 </div>
 </td>
 <td className="py-5 px-6">
 <p className="text-sm font-bold text-slate-800 tracking-tight">{asset.name}</p>
 </td>
 <td className="py-5 px-6">
 <div className="flex items-center gap-2">
 {asset.type === 'equipo' ? (
 ...
 <td className="py-5 px-6">
 <span className={`text-[10px] font-bold px-3 py-1 rounded-lg border shadow-sm ${getStatusStyle(asset.status)}`}>
 {asset.status}
 </span>
 </td>
 ...
 <p className="text-slate-500 font-bold text-lg">No hay activos registrados</p>
