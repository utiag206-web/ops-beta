...
export function AssetImport() {
 ...
 className="bg-white border-2 border-blue-200 hover:bg-blue-50 text-blue-600 px-6 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all flex items-center gap-2 shadow-sm"
 >
 <Download size={16} className="text-blue-600" /> Descargar Plantilla
 </button>
 <label className="bg-blue-600 hover:bg-blue-700 !text-white px-6 py-2.5 rounded-xl text-xs font-black tracking-tight cursor-pointer transition-all shadow-md flex items-center gap-2">
 ...
 <p className="text-xs text-slate-500 font-bold tracking-tight">{data.length} activos listos</p>
 </div>
 </div>
 ...
 disabled={isPending}
 className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-8 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all shadow-lg shadow-blue-100 active:scale-95"
 >
 ...
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Código / Serie</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Nombre del Activo</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Marca</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Modelo</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Categoría</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Ubicación</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Estado</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal text-center">Acción</th>
 </tr>
 </thead>
 ...
 {isExisting ? (
 <span className="px-2 py-0.5 rounded-full text-[9px] font-black tracking-tight bg-amber-50 text-amber-700 border border-amber-100">
 Sobreescribir
 </span>
 ) : (
 <span className="px-2 py-0.5 rounded-full text-[9px] font-black tracking-tight bg-green-50 text-green-700 border border-green-100">
 Crear
 </span>
 )}
 </td>
