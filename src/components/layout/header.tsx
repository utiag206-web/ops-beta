      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col md:flex-row md:items-baseline md:gap-2">
            <h1 className="text-lg md:text-xl font-black text-slate-800 line-clamp-1 uppercase tracking-tight">
              {companyName}
            </h1>
            <p className="text-[9px] text-blue-600 font-black uppercase tracking-[0.2em] opacity-70 hidden sm:block">SISTEMA ERP</p>
          </div>
        </div>
      </div>
