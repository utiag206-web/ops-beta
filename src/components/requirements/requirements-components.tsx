...
export function RequirementStatusBadge({ status }: { status: string }) {
 ...
 return (
 <span className={`text-[9px] font-black px-2.5 py-1 rounded-full border tracking-widest shadow-sm transition-all ${styles[status] || styles.pendiente}`}>
...
export function PriorityBadge({ priority }: { priority: string }) {
 ...
 return (
 <span className={`text-[9px] font-black px-2 py-0.5 rounded-md border ${styles[priority] || styles.media}`}>
 {priority}
 </span>
 )
}
...
export function CreateRequirementModal({ isOpen, onClose, onSuccess }: CreateRequirementModalProps) {
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black tracking-tight text-amber-700 px-1 text-xs">Especificación de Herramienta</label>
 <input 
 type="text"
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black tracking-tight text-amber-700 px-1 text-xs">Cantidad</label>
 <input 
 type="number"
 min="1"
 className="w-full bg-white border-2 border-transparent focus:border-amber-500 rounded-2xl p-3 text-sm font-bold transition-all outline-none"
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black tracking-tight text-emerald-700 px-1 text-xs">Especialidad Requerida</label>
 <input 
 type="text"
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black tracking-tight text-emerald-700 px-1 text-xs">Nro. de Personas</label>
 <input 
 type="number"
 min="1"
 className="w-full bg-white border-2 border-transparent focus:border-emerald-500 rounded-2xl p-3 text-sm font-bold transition-all outline-none"
 ...
 <div className="bg-emerald-50/50 p-4 rounded-3xl border border-emerald-100/50 space-y-4">
 <div className="space-y-2">
 <label className="text-[10px] font-black tracking-tight text-emerald-700 px-1 text-xs">Monto Solicitado (S/)</label>
 <input 
 type="number"
 step="0.01"
 min="0.01"
 ...
 <div className="space-y-2">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Título / Asunto</label>
 <input 
 required
 type="text"
 ...
 <div className="space-y-2">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Justificación detallada</label>
 <textarea 
 rows={3}
...
export function ApproveRequirementModal({ 
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1 flex items-center gap-1">
 <MapPin size={12} />
 Almacén de Origen
 </label>
 <select 
...
export function ReportIncidentModal({ 
 ...
 <div className="space-y-2">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Tipo de Evento</label>
 <select 
 required
 className="w-full bg-slate-50 border-2 border-transparent focus:border-orange-500 focus:bg-white rounded-2xl p-4 text-sm font-bold transition-all outline-none"
 value={form.type}
