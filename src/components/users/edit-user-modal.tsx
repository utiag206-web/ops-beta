...
export function EditUserModal({ isOpen, onClose, onSuccess, user }: EditUserModalProps) {
 ...
 <p className="text-slate-400 text-[10px] font-bold tracking-tight">Gestiona los detalles de acceso y perfil.</p>
 </div>
 ...
 className={`flex-1 py-4 text-xs font-black tracking-widest transition-all ${activeTab === 'profile' ? 'text-blue-600 border-b-2 border-blue-600 bg-blue-50/30' : 'text-slate-400 hover:bg-slate-50'}`}
 >
 Datos de Perfil
 </button>
 <button 
 onClick={() => setActiveTab('auth')}
 className={`flex-1 py-4 text-xs font-black tracking-widest transition-all ${activeTab === 'auth' ? 'text-blue-600 border-b-2 border-blue-600 bg-blue-50/30' : 'text-slate-400 hover:bg-slate-50'}`}
 >
 Seguridad y Acceso
 </button>
 </div>
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Nombre Completo</label>
 ...
 <div className="space-y-2">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Área / Departamento</label>
 <select 
 ...
 <div className="space-y-2">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Correo Electrónico</label>
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Nueva Contraseña</label>
 <div className="flex gap-2">
 <div className="relative flex-1">
