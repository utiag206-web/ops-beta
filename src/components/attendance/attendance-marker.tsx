...
export function AttendanceMarker({ initialStatus }: AttendanceMarkerProps) {
 ...
 <p className="text-[10px] text-slate-400 tracking-tight font-bold">Registro Diario</p>
 </div>
 </div>
 ...
 <p className="text-[10px] text-slate-400 font-bold tracking-tight">Hora Actual</p>
 </div>
 </div>
