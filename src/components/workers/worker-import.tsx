...
export function WorkerImport() {
 ...
 <span className="!text-white">Seleccionar archivo para importar</span>
 <input 
 type="file" 
 className="hidden" 
 accept=".xlsx, .xls, .csv" 
 ...
 <p className="text-xs text-slate-500 font-bold tracking-tight">{data.length} registros</p>
 </div>
 </div>
 ...
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Nombres</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Apellidos</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">DNI</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Cargo</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Teléfono</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal text-center">Validación</th>
 </tr>
 </thead>
