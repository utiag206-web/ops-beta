...
export function AddWorkerModal({ isOpen, onClose }: AddWorkerModalProps) {
 ...
 type="button"
 onClick={onClose}
 className="w-full sm:flex-1 px-4 py-3 border border-slate-300 text-slate-700 rounded-xl hover:bg-slate-50 font-black text-xs tracking-tight transition-colors"
 >
 Cancelar
 </button>
 <button
 type="submit"
 disabled={isPending}
 className="w-full sm:flex-[2] bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-black text-xs tracking-tight py-3 rounded-xl transition-colors shadow-lg shadow-blue-100 flex items-center justify-center"
 >
 {isPending ? (
 <>
