...
export function WorkerFinancialHistory({ bonuses: initialBonuses, worker, isAdmin = false }: WorkerFinancialHistoryProps) {
 ...
 <div>
 <h4 className="text-sm font-black text-slate-800 tracking-tight">Historial Financiero Consolidado</h4>
 <p className="text-xs text-slate-500 mt-0.5">Visualización unificada de pagos, bonos y transporte de este colaborador.</p>
 </div>
 {isAdmin && (
 <button
 onClick={() => setIsAddOpen(true)}
 className="flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl text-xs tracking-normal transition-all cursor-pointer active:scale-95 shadow-sm shadow-emerald-100"
 >
 <Plus size={16} />
 ...
 <th className="py-4 px-6 text-[10px] font-black text-slate-400 tracking-tight">Fecha</th>
 <th className="py-4 px-6 text-[10px] font-black text-slate-400 tracking-tight">Tipo</th>
 <th className="py-4 px-6 text-[10px] font-black text-slate-400 tracking-tight">Concepto</th>
 <th className="py-4 px-6 text-[10px] font-black text-slate-400 tracking-tight">Monto</th>
 <th className="py-4 px-6 text-[10px] font-black text-slate-400 tracking-tight text-center">Estado</th>
 <th className="py-4 px-6 text-[10px] font-black text-slate-400 tracking-tight text-right">Acciones</th>
 </tr>
 </thead>
 ...
 <td className="py-4 px-6">
 <span className={`inline-flex items-center text-[10px] font-black px-2.5 py-0.5 rounded border tracking-wider ${badgeStyles}`}>
 {badgeLabel}
 </span>
 </td>
 <td className="py-4 px-6">
 ...
 className={`text-[9px] font-black px-2.5 py-0.5 rounded-lg border shadow-sm transition-all ${
 ...
 <span className={`inline-flex items-center text-[8px] font-black px-1.5 py-0.5 rounded border tracking-wider ${badgeStyles}`}>
 {badgeLabel}
 </span>
 <span className="text-xs font-bold text-slate-800 leading-none truncate max-w-[150px]">
 {bonus.bonus_type}
 </span>
 </div>
 </div>
