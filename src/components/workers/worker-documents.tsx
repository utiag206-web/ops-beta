...
export function WorkerDocuments({ 
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 mb-1 ml-1">Categoría</label>
 <select 
 name="file_type" 
 required
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-xs font-bold text-slate-500 mb-1 ml-1">Fecha Emisión (Opcional)</label>
 <input 
 name="issue_date" 
 type="date"
 className="w-full px-4 py-2 bg-white border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all text-sm text-slate-900"
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 mb-1 ml-1">Fecha Vencimiento (Opcional)</label>
 <input 
 name="expiry_date" 
 type="date"
 className="w-full px-4 py-2 bg-white border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all text-sm text-slate-900"
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 mb-1 ml-1">Archivo</label>
 ...
 <span className="text-[10px] bg-slate-100 text-slate-600 px-1.5 py-0.5 rounded font-bold tracking-normal">
 {doc.file_type}
 </span>
