...
export function MovementForm({ isOpen, onClose, onSuccess, products }: MovementFormProps) {
 ...
 <div>
 <p className="font-black text-sm tracking-tight">Error de Configuración ERP</p>
 ...
 className="w-full bg-rose-600 text-white font-black py-3 rounded-2xl text-[10px] tracking-tight hover:bg-rose-700 transition-colors"
 >
 ...
 className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl text-[11px] font-black tracking-tight transition-all duration-300 ${
 isActive 
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Ubicación <span className="text-rose-500">*</span></label>
 <select 
 required
 ...
 <div className="md:col-span-3 space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Código de Producto</label>
 <input 
 type="text"
 placeholder="Ej: ABC..."
 className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 rounded-2xl p-4 text-sm font-black transition-all outline-none"
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Descripción del Producto <span className="text-rose-500">*</span></label>
 ...
 className={`px-4 py-3 text-sm font-bold cursor-pointer hover:bg-indigo-50 hover:text-indigo-600 transition-colors ${
 ...
 {dropdownOpen && filteredProducts.length === 0 && (
 <div className="absolute z-50 left-0 right-0 mt-1 bg-white border border-slate-200 rounded-2xl shadow-xl p-4 text-center text-xs text-slate-400 font-bold">
 Sin coincidencias
 </div>
 )}
 </div>
 ...
 <label className="text-[11px] font-black tracking-tight text-emerald-600 px-1">Cantidad a Ingresar</label>
 <div className="relative">
 <input 
 type="number"
 ...
 />
 <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-slate-300 tracking-tight">
 {selectedProduct?.unit || 'UND'}
 </span>
 </div>
 </div>
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Origen / Documento</label>
 <select 
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-rose-500 px-1">Cantidad a Retirar</label>
 <div className="relative">
 <input 
 type="number"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Responsable del Retiro</label>
 <input 
 type="text"
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-indigo-600 px-1">Cantidad a Trasladar</label>
 <input 
 type="number"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-indigo-600 px-1">Almacén de Destino <span className="text-rose-500">*</span></label>
 <select 
 required
 ...
 <span className="text-[10px] font-black text-indigo-700 tracking-tight">Documento Generado: {form.document_number}</span>
 </div>
 </div>
 )}
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-amber-600 px-1">Cantidad a Ajustar <span className="text-rose-500">*</span></label>
 <div className="relative">
 <input 
 type="number"
 placeholder="0"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Referencia / Hallazgo</label>
 <input 
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Documento de Referencia (Nº)</label>
 <input 
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Motivo / Observación</label>
 <input 
 ...
 <button type="button" onClick={onClose} className="flex-1 bg-slate-100 text-slate-600 font-black py-5 rounded-3xl transition-all hover:bg-slate-200 tracking-tight text-[10px]">
 Cancelar
 </button>
 <button 
 disabled={loading}
 type="submit"
 className="flex-[2] bg-slate-900 hover:bg-black text-white font-black py-5 rounded-3xl shadow-xl shadow-slate-100 transition-all flex items-center justify-center gap-3 tracking-tight text-[10px]"
 >
