...
export function ProductsList({ initialProducts }: { initialProducts: Product[] }) {
 ...
 <select 
 className="bg-transparent w-full outline-none text-[11px] font-bold tracking-tighter"
 ...
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight">Rubro</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight">Descripción del Producto</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight text-center">Unidad</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight text-center">Tipo</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight text-center">Stock Actual</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight text-center">Stock Mín</th>
 <th className="py-5 px-6 text-[11px] font-bold text-slate-400 tracking-tight text-center">Vence</th>
 ...
 <span className="text-[11px] font-bold text-indigo-600 tracking-tight leading-none">
 {product.code || 'S/N'}
 </span>
 </div>
 </td>
 ...
 <td className="py-5 px-6 text-center">
 {product.has_expiry ? (
 <span className="text-[10px] font-bold bg-rose-50 text-rose-600 px-2.5 py-1.5 rounded-md border border-rose-100">
 {product.expiry_date ? new Date(product.expiry_date).toLocaleDateString() : 'SÍ'}
 </span>
 ) : (
 <span className="text-[10px] font-bold text-slate-300 tracking-tight">—</span>
 )}
 </td>
