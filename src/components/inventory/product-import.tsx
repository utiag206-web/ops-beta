...
export function ProductImport() {
 ...
 className="bg-white border-2 border-indigo-200 hover:bg-indigo-50 text-indigo-600 px-6 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all flex items-center gap-2 shadow-sm"
 >
 <Download size={16} className="text-indigo-600" /> Descargar Plantilla
 </button>
 <label className="bg-indigo-600 hover:bg-indigo-700 !text-white px-6 py-2.5 rounded-xl text-xs font-black tracking-tight cursor-pointer transition-all shadow-md flex items-center gap-2">
 ...
 <p className="text-xs text-slate-500 font-bold tracking-tight">{data.length} productos listos</p>
 </div>
 </div>
 ...
 disabled={isPending}
 className="w-full sm:w-auto flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white px-8 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all shadow-lg shadow-indigo-100 active:scale-95"
 >
 ...
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Código</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Nombre del Producto</th>
 ...
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Stock Mín.</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Stock Inicial</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal">Almacén Destino</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-500 tracking-normal text-center">Estado</th>
 </tr>
 </thead>
