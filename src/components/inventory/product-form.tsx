...
export function ProductForm({ isOpen, onClose, onSuccess, editingProduct, isViewOnly }: ProductFormProps) {
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Código</label>
 <input 
 required
 disabled={isViewOnly}
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Rubro / Categoría</label>
 <input 
 required
 disabled={isViewOnly}
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Nombre o Descripción</label>
 <input 
 required
 disabled={isViewOnly}
 type="text"
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Unidad de Medida</label>
 <select 
 required
 disabled={isViewOnly}
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Tipo</label>
 <select 
 required
 disabled={isViewOnly}
 className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl p-4 text-sm font-bold transition-all outline-none disabled:opacity-70 appearance-none"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Equivalencia (Opcional)</label>
 <input 
 disabled={isViewOnly}
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Stock Mínimo</label>
 <input 
 required
 disabled={isViewOnly}
 type="number"
 ...
 <span className="text-xs font-bold text-slate-600">¿Vence?</span>
 </div>
 
 {form.has_expiry && (
 <div className="space-y-1.5 animate-in slide-in-from-top-2 duration-200">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Fecha de Vencimiento</label>
 <input 
 ...
 <Box size={18} />
 <h3 className="text-xs font-black tracking-tight">Configuración Stock Inicial</h3>
 </div>
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="space-y-1.5">
 <label className="text-[10px] font-black tracking-tight text-emerald-600/60 px-1">Ubicación</label>
 <input 
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[10px] font-black tracking-tight text-emerald-600/60 px-1">Cant. Inicial</label>
 <input 
 type="number"
 min="0"
