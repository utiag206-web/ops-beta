...
export function WarehouseForm({ isOpen, onClose, onSuccess, editingWarehouse }: WarehouseFormProps) {
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Nombre del Almacén <span className="text-rose-500">*</span></label>
 <input 
 required
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Código (Opcional)</label>
 <input 
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Área Operativa <span className="text-rose-500">*</span></label>
 <select
 required
