...
export function StockForm({ isOpen, onClose, onSuccess, products, editingItem }: StockFormProps) {
 ...
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Producto / Insumo</label>
 <select 
 required
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Almacén</label>
 <select 
 required
 className="w-full bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white rounded-2xl p-4 text-sm font-bold transition-all outline-none appearance-none"
 ...
 <div className="space-y-1.5">
 <label className="text-[11px] font-black tracking-tight text-slate-400 px-1">Cantidad Actual</label>
 <input 
 required
 type="number"
 step="0.01"
