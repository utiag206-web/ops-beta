...
export function CompaniesList({ companies }: { companies: any[] }) {
 ...
 <th className="px-8 py-4 text-[10px] font-black text-slate-400 tracking-tight">Empresa</th>
 <th className="px-8 py-4 text-[10px] font-black text-slate-400 tracking-tight">Información</th>
 <th className="px-8 py-4 text-[10px] font-black text-slate-400 tracking-tight text-center">Estado</th>
 <th className="px-8 py-4 text-[10px] font-black text-slate-400 tracking-tight text-right">Acciones</th>
 </tr>
 </thead>
 ...
 {company.is_test && (
 <span className="bg-purple-100 text-purple-700 text-[9px] px-2 py-0.5 rounded-md font-black tracking-normal flex items-center gap-1">
 <FlaskConical size={10} />
 Prueba
 </span>
 )}
 </div>
 <span className="text-[10px] font-mono text-slate-400 tracking-tighter">{company.id}</span>
 </div>
 </div>
 </td>
 <td className="px-8 py-6">
 ...
 <span className={`inline-flex px-3 py-1 rounded-full text-[10px] font-black tracking-wider ${
