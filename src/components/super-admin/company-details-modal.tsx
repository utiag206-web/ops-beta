...
export function CompanyDetailsModal({ isOpen, onClose, companyId }: CompanyDetailsModalProps) {
 ...
 <>
 <span className={`px-3 py-0.5 rounded-full text-[10px] font-black tracking-wider ${
 ...
 <span className="bg-purple-50 text-purple-600 border border-purple-100 text-[10px] px-3 py-0.5 rounded-full font-black tracking-normal">
 Entorno de Prueba
 </span>
 )}
 </>
