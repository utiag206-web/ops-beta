        ...
        <div className="bg-white rounded-[2.5rem] w-full max-w-md overflow-hidden shadow-2xl animate-in zoom-in duration-300">
          <div className="p-10 text-center">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 text-left space-y-4 border border-slate-100 mb-8">
              ...
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Email Administrador</p>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Nombre Administrador</label>
              <div className="relative">
            ...
            <div className="col-span-1 md:col-span-2 space-y-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4 flex justify-between items-center">
            ...
            <div className="col-span-1 md:col-span-2">
              <label className="flex items-center gap-3 p-4 bg-slate-50 hover:bg-slate-100 rounded-2xl cursor-pointer transition-colors border-2 border-transparent focus-within:border-slate-900 group">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] font-medium text-slate-400 uppercase tracking-wider">Habilita la eliminación futura y marca como entorno de desarrollo</span>
                </div>
              </label>
            </div>
          </div>
